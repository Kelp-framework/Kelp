...
subtest 'path encoding cp1250 ok' => sub {
    ...
    _t(
        ...
        '', 200, encode($app->charset, $test_string)
    );
};
...
subtest 'plaintext encoding utf8 ok' => sub {
    ...
    _t(
        '/body_echo', 'application/x-www-form-urlencoded; charset=utf-8',
...
subtest 'plaintext encoding cp1250 ok' => sub {
    ...
    _t(
        '/body_echo', 'application/x-www-form-urlencoded; charset=cp1250',
        $string, 200, encode($app->charset, $test_string)
    );
};
...
subtest 'plaintext encoding unknown is utf8 ok' => sub {
    ...
    _t(
        '/body_echo', 'application/x-www-form-urlencoded; charset=xxnotanencoding',
        $string, 200, encode($app->charset, $test_string)
    );
};
